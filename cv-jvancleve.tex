...
\usepackage{enumitem}
\setlist[itemize,1]{label=,leftmargin=0ex,itemsep=0.25ex}
\setlist[itemize,2]{label=--,itemsep=0.2ex}
...
\titlespacing*{\section}{-2ex}{1.5ex plus 0.5ex minus 0.5ex}{0.25ex plus 0.25ex minus 0.25ex}
...
\begin{center}
  \begin{tabular*}{6.45in}{p{1.75in}@{\hspace{0.25in}}p{2.45in}@{\hspace{0.25in}}p{1.75in}}
    ...
    \begin{minipage}{1.75in} \raggedleft
      ...
      % \href{http://twitter.com/jeremyvancleve}{Twitter: @jeremyvancleve}
    \end{minipage}
...
\section{Preprints}
  ...
  { \setlength{\parskip}{1.25ex}
    \bibentry{Van-CleveConform}

    \bibentry{WilkinsBioessays}

    \bibentry{HokeCriticalPeriod}

    \bibentry{LehmannInvasionFit}
    
    \bibentry{AndrisSocialCapital}
...
% }
  ...
  \item University of Kentucky
    \begin{itemize}
    \item Fall 2015. BIO 770 Graudate Seminar: ``Dr. Pangloss reborn? Natural selection in evolution''
    \item Spring 2016. BIO 325 Ecology
    \item Mentor: Hugh Ronald, Paul Laurence Dunbar High School, Lexington, KY (2015--2016)
    \end{itemize}
  \item NESCent
    \begin{itemize}
